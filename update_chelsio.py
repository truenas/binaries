...
if __name__ == "__main__":
    ...
    try:
        ...
        subprocess.check_call(
            f"mv {directory}/tools/chelsio_adapter_config_v4/bin/new/chelsio_adapter_config.py files/usr/sbin/",
            shell=True,
        )
        subprocess.check_call(
            f"mv {directory}/tools/chelsio_adapter_config_v4/vpds/* files/usr/lib/firmware/cxgb4/config/",
            shell=True,
        )
        subprocess.check_call(
            f"mv {directory}/tools/chelsio_adapter_config_v4/bin/t5seeprom_bins/t5seeprom files/usr/sbin/",
            shell=True,
        )
        subprocess.check_call(
            f"mv {directory}/tools/chelsio_adapter_config_v4/bin/t6seeprom_bins/t6seeprom files/usr/sbin/",
            shell=True,
        )
    finally:
